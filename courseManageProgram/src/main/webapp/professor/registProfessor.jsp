...
<link
	...
	rel="stylesheet">
<!-- Custom CSS -->
<link href="<%=request.getContextPath()%>/css/registProfessor.css"
	rel="stylesheet">
</head>
<body>
	<div class="register-container">
		<div class="form-title">교수 회원가입</div>
		<form action="registProfessor.do" method="post">
			...
			<button type="submit"
				onclick="location.href='/professor/registProfessor.do'"
			...
			<c:when test="${status>=1}">
				<script type="text/javascript">
					...
					if(document.getElementsByClassName("register-container")) {
						window.location.assign("/login/loginMain.jsp");
					}
				</script>
			</c:when>
			<c:otherwise>
